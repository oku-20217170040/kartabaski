...
function floorTo25(n: number): string {
  const floored = Math.max(25, Math.floor(n / 25) * 25);
  return `${floored}+`;
}

// İşletme 2021'de kuruldu, her yıl otomatik artar
...
export default function HeroSection({ productCount = 0 }: Props) {
  const STATS = [
    { value: floorTo25(productCount), label: 'Ürün' },
    { value: 'Aynı Gün', label: 'Teslimat' },
    { value: yearsOfExperience(), label: 'Deneyim' },
